...
fun ActionButtons(
    ...
    Row(
        ...
        Button(
            ...
            text = dropoffConfirmationUiViewModel.currentTripInfo.userInfo.userName,
        ) {
        ...
        Button(
            ...
            dropoffConfirmationUiViewModel.onClickTextingButton(context)
        }
        Button(
            icon = painterResource(id = R.drawable.confirm_pickup_ic_call),
            text = stringResource(id = R.string.call),
        ) {
            dropoffConfirmationUiViewModel.onClickCallButton(context)
        }
        Button(
            icon = painterResource(id = R.drawable.confirm_pickup_ic_close),
            text = stringResource(id = R.string.cancel_trip),
        ) {
            dropoffConfirmationUiViewModel.onClickCancelTripButton(context)
        }
    }
}
