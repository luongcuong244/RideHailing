...
fun FareAmount(
    ...
    Column(
        ...
        Row(
            ...
            TextItem(
                value = pickupConfirmationUiViewModel.currentTripInfo.distanceInKilometers.toString(),
                unit = "km"
            )
            TextItem(
                value = FormatterUtils.formatCurrency(
                    pickupConfirmationUiViewModel.currentTripInfo.cost * 1000
                ),
                unit = "đ"
            )
            TextItem(
                value = pickupConfirmationUiViewModel.currentTripInfo.durationInMinutes.toString(),
                unit = "phút"
            )
        }
    }
